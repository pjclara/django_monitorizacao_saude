const pt = {
  ...
  'The start date of the device must be equal to or greater than today':
    'A data de início do dispositivo deve ser igual ou superior à data de hoje',
  'The end date must be greater than the start date.':
    'A data de fim deve ser maior que a data de início.',
  'The start date must be equal to or greater than today.':
    'A data de início deve ser igual ou superior à data de hoje.',
